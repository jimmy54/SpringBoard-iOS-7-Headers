...
@class SBFolder, SBLeafIcon, SBIconContentView, SBIconColorSettings, BBObserver, NSTimer, _UILegibilitySettings, NSMutableSet, NSMutableArray, UITouch, SBRootFolderController, NSSet, NSIndexPath, SBIconModel, SBIcon;
