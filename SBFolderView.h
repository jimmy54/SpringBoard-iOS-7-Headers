...
@class SBIconViewMap, NSArray, NSMutableArray, _UILegibilitySettings, SBIconScrollView, SBIconListPageControl, SBFolder, SBIconListView, SBFolderTitleTextField;
