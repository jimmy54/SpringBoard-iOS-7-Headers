...
@class SBIconImageView, SBFolderIconBackgroundView, NSTimer, _UILegibilitySettings, SBFParallaxSettings, _UILegibilityView, SBIconImageCrossfadeView, SBCloseBoxView, SBIcon;
