...
@class NSObject, NSMutableDictionary, UIView, NSArray, SBFakeStatusBarViewCache, NSMutableSet, NSMutableArray, SBAppSwitcherServices, SBAppSliderSettings, SBAppSliderIconController, NSDictionary, SBAppSliderScrollingViewController, NSString;
