...
@class NSHashTable, NSString, NSArray, NSMutableDictionary, SBWindowContextManager, SBActivationContext, NSTimer, NSMapTable, NSMutableSet, NSMutableArray, NSDictionary, NSSet, BKSCFBundle, BKSMachSendRight, NSDate, UIRemoteApplication, PCPersistentTimer, UILocalNotification, BKSProcessAssertion, BKSApplicationDataStore;
