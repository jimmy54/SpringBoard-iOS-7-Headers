...
@class SBChevronView, NSMutableSet, NSHashTable, UIView, SBApplication, _UIBackdropView, SBControlCenterWindow, SBControlCenterRootView, SBControlCenterViewController;
