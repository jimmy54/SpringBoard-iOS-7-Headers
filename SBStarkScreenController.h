...
@class AVExternalDevice, NSTimer, SBCarDisplaySettings, SBStarkHomeController, SBStarkSiriWindow, UIWindow, SBStarkLockOutViewController, SBStarkNotificationWindow, SBAlertManager, SBStarkFakeIconOperationController, UIScreen, SBStarkLockOutWindow, SBStarkDefaultHostingWindow, SBStarkScreenFocusController, _UIBackdropView;
