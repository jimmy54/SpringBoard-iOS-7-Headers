...
@class SBLockScreenBounceAnimator, UIScrollView, SBFakeStatusBarView, SBLockScreenTimerView, SBWallpaperEffectView, SBFLockScreenDateView, SBLockScreenBatteryChargingView, SBFGlintyStringView, _UILegibilityLabel, SBDisableAppStatusBarAlphaChangesAssertion, _UILegibilitySettings, NSMutableSet, NSMutableArray, _UIBackdropView, SBLockScreenScrollView, SBChevronView, SBLockOverlayStylePropertiesFactory, SBSlideToUnlockFailureRecognizer;
