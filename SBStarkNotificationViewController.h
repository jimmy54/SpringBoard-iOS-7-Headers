...
@class UITapGestureRecognizer, NSArray, SBUIBannerContext, SBStarkBulletinBannerSource, UICollectionView, SBStarkBannerCell, SBStarkNotificationLayout, SBStarkAlertItemBannerSource, SBStarkBannerTarget;
